...
XPathExpression.prototype.evaluate = function(n, t, res) {
	...
	return new XPathResult$1(result, t);
};
...
XPathResult$1.prototype = {};
XPathResult$1.prototype.constructor = XPathResult$1;
XPathResult$1.superclass = Object.prototype;

function XPathResult$1(v, t) {
	if (t == XPathResult$1.ANY_TYPE) {
		if (v.constructor === XString) {
			t = XPathResult$1.STRING_TYPE;
		} else if (v.constructor === XNumber) {
			t = XPathResult$1.NUMBER_TYPE;
		} else if (v.constructor === XBoolean) {
			t = XPathResult$1.BOOLEAN_TYPE;
		} else if (v.constructor === XNodeSet) {
			t = XPathResult$1.UNORDERED_NODE_ITERATOR_TYPE;
		}
	}
	this.resultType = t;
	switch (t) {
		case XPathResult$1.NUMBER_TYPE:
			this.numberValue = v.numberValue();
			return;
		case XPathResult$1.STRING_TYPE:
			this.stringValue = v.stringValue();
			return;
		case XPathResult$1.BOOLEAN_TYPE:
			this.booleanValue = v.booleanValue();
			return;
		case XPathResult$1.ANY_UNORDERED_NODE_TYPE:
		case XPathResult$1.FIRST_ORDERED_NODE_TYPE:
			if (v.constructor === XNodeSet) {
				this.singleNodeValue = v.first();
				return;
			}
			break;
		case XPathResult$1.UNORDERED_NODE_ITERATOR_TYPE:
		case XPathResult$1.ORDERED_NODE_ITERATOR_TYPE:
			if (v.constructor === XNodeSet) {
			...
			break;
		case XPathResult$1.UNORDERED_NODE_SNAPSHOT_TYPE:
		case XPathResult$1.ORDERED_NODE_SNAPSHOT_TYPE:
			if (v.constructor === XNodeSet) {
				this.nodes = v.toArray();
...
XPathResult$1.prototype.iterateNext = function() {
	if (this.resultType != XPathResult$1.UNORDERED_NODE_ITERATOR_TYPE
			&& this.resultType != XPathResult$1.ORDERED_NODE_ITERATOR_TYPE) {
		throw new XPathException(XPathException.TYPE_ERR);
	}
	return this.nodes[this.iteratorIndex++];
};

XPathResult$1.prototype.snapshotItem = function(i) {
	if (this.resultType != XPathResult$1.UNORDERED_NODE_SNAPSHOT_TYPE
			&& this.resultType != XPathResult$1.ORDERED_NODE_SNAPSHOT_TYPE) {
		throw new XPathException(XPathException.TYPE_ERR);
	}
	return this.nodes[i];
};

XPathResult$1.ANY_TYPE = 0;
XPathResult$1.NUMBER_TYPE = 1;
XPathResult$1.STRING_TYPE = 2;
XPathResult$1.BOOLEAN_TYPE = 3;
XPathResult$1.UNORDERED_NODE_ITERATOR_TYPE = 4;
XPathResult$1.ORDERED_NODE_ITERATOR_TYPE = 5;
XPathResult$1.UNORDERED_NODE_SNAPSHOT_TYPE = 6;
XPathResult$1.ORDERED_NODE_SNAPSHOT_TYPE = 7;
XPathResult$1.ANY_UNORDERED_NODE_TYPE = 8;
XPathResult$1.FIRST_ORDERED_NODE_TYPE = 9;
...
function setEngine(name, crypto, subtle)
{
	...
	if((typeof process !== "undefined") && ("pid" in process) && (typeof commonjsGlobal !== "undefined"))
	{
		// noinspection ES6ModulesDependencies, JSUnresolvedVariable
		if(typeof commonjsGlobal[process.pid] === "undefined")
		{
			// noinspection JSUnresolvedVariable
			commonjsGlobal[process.pid] = {};
		}
		else
		{
			// noinspection JSUnresolvedVariable
			if(typeof commonjsGlobal[process.pid] !== "object")
			{
				// noinspection JSUnresolvedVariable
		...
		// noinspection JSUnresolvedVariable
		if(typeof commonjsGlobal[process.pid].pkijs === "undefined")
		{
			// noinspection JSUnresolvedVariable
			commonjsGlobal[process.pid].pkijs = {};
		}
		else
		{
			// noinspection JSUnresolvedVariable
			if(typeof commonjsGlobal[process.pid].pkijs !== "object")
			{
				// noinspection JSUnresolvedVariable
		...
		// noinspection JSUnresolvedVariable
		commonjsGlobal[process.pid].pkijs.engine = {
			name: name,
			crypto: crypto,
			subtle: subtle
		};
...
function getEngine()
{
	...
	if((typeof process !== "undefined") && ("pid" in process) && (typeof commonjsGlobal !== "undefined"))
	{
		...
		{
			// noinspection JSUnresolvedVariable
			_engine = commonjsGlobal[process.pid].pkijs.engine;
		}
		catch(ex)
		{
...
let xpath$$1 = (node, xPath) => {
    throw new Error("Not implemented");
};
let sWindow;
if (typeof self === "undefined") {
    sWindow = commonjsGlobal;
...
const Select = (typeof self !== "undefined") ? SelectNodesEx : xpath$$1;
...
var dist_1 = dist.XmlCanonicalizerState;
var dist_2 = dist.X509IncludeOption;
var dist_3 = dist.Select;
var dist_4 = dist.Parse;
var dist_5 = dist.Stringify;
var dist_6 = dist.Application;
var dist_7 = dist.XmlCanonicalizer;
var dist_8 = dist.CryptoConfig;
var dist_9 = dist.XmlSignature;
var dist_10 = dist.XmlSignatureObject;
var dist_11 = dist.XmlSignatureCollection;
var dist_12 = dist.CanonicalizationMethod;
var dist_13 = dist.DataObject;
var dist_14 = dist.DataObjects;
var dist_15 = dist.DigestMethod;
var dist_16 = dist.KeyInfo;
var dist_17 = dist.Reference;
var dist_18 = dist.References;
var dist_19 = dist.Signature;
var dist_20 = dist.SignatureMethodOther;
var dist_21 = dist.SignatureMethod;
var dist_22 = dist.SignedInfo;
var dist_23 = dist.XmlDsigBase64Transform;
var dist_24 = dist.XmlDsigC14NTransform;
var dist_25 = dist.XmlDsigC14NWithCommentsTransform;
var dist_26 = dist.XmlDsigEnvelopedSignatureTransform;
var dist_27 = dist.XmlDsigExcC14NTransform;
var dist_28 = dist.XmlDsigExcC14NWithCommentsTransform;
var dist_29 = dist.XmlDsigDisplayFilterTransform;
var dist_30 = dist.Transform;
var dist_31 = dist.Transforms;
var dist_32 = dist.X509Certificate;
var dist_33 = dist.KeyInfoClause;
var dist_34 = dist.KeyValue;
var dist_35 = dist.EcdsaPublicKey;
var dist_36 = dist.NamedCurve;
var dist_37 = dist.DomainParameters;
var dist_38 = dist.EcdsaKeyValue;
var dist_39 = dist.RsaKeyValue;
var dist_40 = dist.MaskGenerationFunction;
var dist_41 = dist.PssAlgorithmParams;
var dist_42 = dist.X509IssuerSerial;
var dist_43 = dist.KeyInfoX509Data;
var dist_44 = dist.SPKIData;
var dist_45 = dist.SelectRootNamespaces;
var dist_46 = dist.SignedXml;

exports.default = index;
exports.XmlCanonicalizerState = dist_1;
exports.X509IncludeOption = dist_2;
exports.Select = dist_3;
exports.Parse = dist_4;
exports.Stringify = dist_5;
exports.Application = dist_6;
exports.XmlCanonicalizer = dist_7;
exports.CryptoConfig = dist_8;
exports.XmlSignature = dist_9;
exports.XmlSignatureObject = dist_10;
exports.XmlSignatureCollection = dist_11;
exports.CanonicalizationMethod = dist_12;
exports.DataObject = dist_13;
exports.DataObjects = dist_14;
exports.DigestMethod = dist_15;
exports.KeyInfo = dist_16;
exports.Reference = dist_17;
exports.References = dist_18;
exports.Signature = dist_19;
exports.SignatureMethodOther = dist_20;
exports.SignatureMethod = dist_21;
exports.SignedInfo = dist_22;
exports.XmlDsigBase64Transform = dist_23;
exports.XmlDsigC14NTransform = dist_24;
exports.XmlDsigC14NWithCommentsTransform = dist_25;
exports.XmlDsigEnvelopedSignatureTransform = dist_26;
exports.XmlDsigExcC14NTransform = dist_27;
exports.XmlDsigExcC14NWithCommentsTransform = dist_28;
exports.XmlDsigDisplayFilterTransform = dist_29;
exports.Transform = dist_30;
exports.Transforms = dist_31;
exports.X509Certificate = dist_32;
exports.KeyInfoClause = dist_33;
exports.KeyValue = dist_34;
exports.EcdsaPublicKey = dist_35;
exports.NamedCurve = dist_36;
exports.DomainParameters = dist_37;
exports.EcdsaKeyValue = dist_38;
exports.RsaKeyValue = dist_39;
exports.MaskGenerationFunction = dist_40;
exports.PssAlgorithmParams = dist_41;
exports.X509IssuerSerial = dist_42;
exports.KeyInfoX509Data = dist_43;
exports.SPKIData = dist_44;
exports.SelectRootNamespaces = dist_45;
exports.SignedXml = dist_46;
