...
context("PKI X509", () => {
  ...
  it("thumbprint sha256", async () => {
    ...
    assert.equal(Convert.ToBase64(new Uint8Array(hash)), "3SYVGIWfXYYHrbeFU3LSrvEbN9HBVXRqJwQjSLhqStU=");
  });
  ...
  it("exportKey ecdsa", async () => {
    const x509 = new xmldsig.X509Certificate(x509Ecdsa);
