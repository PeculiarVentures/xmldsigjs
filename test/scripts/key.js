...
describe("Key", function () {
    ...
    context("X509Certificate", () => {
        ...
        it("Init with raw", () => {
            ...
            cert = new xmldsig.X509Certificate(xmljs.Convert.FromBase64(certBase64));
            ...
            [
                ...
                it(v.digest, done => {
                    ...
                    cert.Thumbprint(v.digest)
                        .then(hash => {
                            assert.equal(xmljs.Convert.ToHex(new Uint8Array(hash)), v.value)
                            done();
                        })
                        .catch(done);
                }))
