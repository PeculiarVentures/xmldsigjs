...
import { SHA1, SHA224, SHA256, SHA384, SHA512 } from "../algorithm/rsa_hash";
...
export const HMAC_SHA224_NAMESPACE = "http://www.w3.org/2001/04/xmldsig-more#hmac-sha224";
...
export class HmacSha224 extends SignatureAlgorithm {
    ...
    xmlNamespace = HMAC_SHA224_NAMESPACE;
}
